            ...
            ModuleInfo module = new ModuleInfo()
            {
                ...
                BibleStructure = new BibleStructureInfo()
                {
                    ...
                    BibleBooks = new List<BibleBookInfo>()
                    {
                        ...
                        new BibleBookInfo() { Name = "1-я Царств", SectionName = "09. 1-я Царств", Abbreviations = new List<string>() { "1цар", "1 цар", "1цр", "1ц", "1царств", "1-я царств", "1 царств" } },
                        new BibleBookInfo() { Name = "2-я Царств", SectionName = "10. 2-я Царств", Abbreviations = new List<string>() { "2цар", "2 цар", "2цр", "2ц", "2царств", "2-я царств", "2 царств" } },
                        new BibleBookInfo() { Name = "3-я Царств", SectionName = "11. 3-я Царств", Abbreviations = new List<string>() { "3цар", "3 цар", "3цр", "3ц", "3царств", "3-я царств", "3 царств" } },
                        new BibleBookInfo() { Name = "4-я Царств", SectionName = "12. 4-я Царств", Abbreviations = new List<string>() { "4цар", "4 цар", "4цр", "4ц", "4царств", "4-я царств", "4 царств" } },
                        new BibleBookInfo() { Name = "1-я Паралипоменон", SectionName = "13. 1-я Паралипоменон", Abbreviations = new List<string>() { "1пар", "1пр", "1 пар", "1-я паралипоменон" } },
                        new BibleBookInfo() { Name = "2-я Паралипоменон", SectionName = "14. 2-я Паралипоменон", Abbreviations = new List<string>() { "2пар", "2пр", "2 пар", "2-я паралипоменон" } },
                        ...
                        new BibleBookInfo() { Name = "Исаия", SectionName = "23. Исаия", Abbreviations = new List<string>() { "ис", "иса", "исаия" } },
                        ...
                        new BibleBookInfo() { Name = "1-е Петра", SectionName = "07. 1-е Петра", Abbreviations = new List<string>() { "1пет", "1 пет", "1пт", "1птр", "1 птр", "1петр", "1 петр", "1петра", "1-е петра", "1 петра", "1 петр", "1-е петр" } },
                        new BibleBookInfo() { Name = "2-е Петра", SectionName = "08. 2-е Петра", Abbreviations = new List<string>() { "2пет", "2 пет", "2пт", "2птр", "2 птр", "2петр", "2 петр", "2петра", "2-е петра", "2 петра", "2 петр", "2-е петр" } },
                        new BibleBookInfo() { Name = "1-е Иоанна", SectionName = "09. 1-е Иоанна", Abbreviations = new List<string>() { "1иоан", "1ин", "1иоанн", "1иоанна", "1-е иоанна", "1 иоанн", "1 иоанна", "1 ин", "1 иоан", "1-е иоанн", "1-е иоан", "1-е ин" } },
                        new BibleBookInfo() { Name = "2-е Иоанна", SectionName = "10. 2-е Иоанна", Abbreviations = new List<string>() { "2иоан", "2ин", "2иоанн", "2иоанна", "2-е иоанна", "2 иоанн", "2 иоанна", "2 ин", "2 иоан", "2-е иоанн", "2-е иоан", "2-е ин" } },
                        new BibleBookInfo() { Name = "3-е Иоанна", SectionName = "11. 3-е Иоанна", Abbreviations = new List<string>() { "3иоан", "3ин", "3иоанн", "3иоанна", "3-е иоанна", "3 иоанн", "3 иоанна", "3 ин", "3 иоан", "3-е иоанн", "3-е иоан", "3-е ин" } },
                        ...
                        new BibleBookInfo() { Name = "1-е Коринфянам", SectionName = "14. 1-е Коринфянам", Abbreviations = new List<string>() { "1кор", "1 кор", "1коринф", "1коринфянам", "1-е коринфянам", "1 коринфянам", "1 коринф", "1-е коринф", "1-е кор" } },
                        new BibleBookInfo() { Name = "2-е Коринфянам", SectionName = "15. 2-е Коринфянам", Abbreviations = new List<string>() { "2кор", "2 кор", "2коринф", "2коринфянам", "2-е коринфянам", "2 коринфянам", "2 коринф", "2-е коринф", "2-е кор" } },
                        ...
                        new BibleBookInfo() { Name = "1-е Фессалоникийцам", SectionName = "20. 1-е Фессалоникийцам", Abbreviations = new List<string>() { "1фесс", "1фес", "1фессалоникийцам", "1 фес", "1 фесс", "1-е фессалоникийцам", "1 фессалоникийцам", "1-е фесс", "1-е фес" } },
                        new BibleBookInfo() { Name = "2-е Фессалоникийцам", SectionName = "21. 2-е Фессалоникийцам", Abbreviations = new List<string>() { "2фесс", "2фес", "2фессалоникийцам", "2 фес", "2 фесс", "2-е фессалоникийцам", "2 фессалоникийцам", "2-е фесс", "2-е фес" } },
                        new BibleBookInfo() { Name = "1-е Тимофею", SectionName = "22. 1-е Тимофею", Abbreviations = new List<string>() { "1тим", "1тимоф", "1тимофею", "1 тимофею", "1-е тимофею", "1 тим", "1 тимоф", "1-е тимоф", "1-е тим" } },
                        new BibleBookInfo() { Name = "2-е Тимофею", SectionName = "23. 2-е Тимофею", Abbreviations = new List<string>() { "2тим", "2тимоф", "2тимофею", "2 тимофею", "2-е тимофею", "2 тим", "2 тимоф", "2-е тимоф", "2-е тим" } },
