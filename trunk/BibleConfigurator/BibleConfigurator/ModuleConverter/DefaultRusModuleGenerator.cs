            ...
            ModuleInfo module = new ModuleInfo()
            {
                ...
                BibleStructure = new BibleStructureInfo()
                {
                    ...
                    BibleBooks = new List<BibleBookInfo>()
                    {
                        ...
                        new BibleBookInfo() { Name = "1-я Паралипоменон", SectionName = "13. 1-я Паралипоменон", Abbreviations = new List<string>() { "1пар", "1пр",  "1-я паралипоменон" } },
                        new BibleBookInfo() { Name = "2-я Паралипоменон", SectionName = "14. 2-я Паралипоменон", Abbreviations = new List<string>() { "2пар", "2пр",  "2-я паралипоменон" } },
