        ...
        public static readonly Dictionary<string, StringCollection> BookNames = new Dictionary<string, StringCollection>()
            {
                ...
                { "07. 1-е Петра", new StringCollection() { "1пет", "1 пет", "1пт", "1птр", "1 птр", "1петр", "1 петр", "1петра", "1-е петра", "1 петра", "1 петр" } },
                { "08. 2-е Петра", new StringCollection() { "2пет", "2 пет", "2пт", "2птр", "2 птр", "2петр", "2 петр", "2петра", "2-е петра", "2 петра", "2 петр" } },
                { "09. 1-е Иоанна", new StringCollection() { "1иоан", "1ин", "1иоанн", "1иоанна", "1-е иоанна", "1 иоанн", "1 иоанна", "1 ин", "1 иоан" } },
                { "10. 2-е Иоанна", new StringCollection() { "2иоан", "2ин", "2иоанн", "2иоанна", "2-е иоанна", "2 иоанн", "2 иоанна", "2 ин", "2 иоан" } },
                { "11. 3-е Иоанна", new StringCollection() { "3иоан", "3ин", "3иоанн", "3иоанна", "3-е иоанна", "3 иоанн", "3 иоанна", "3 ин", "3 иоан" } },
                { "12. Иуды", new StringCollection() { "иуд", "ид", "иуда", "иуды" } },
                { "13. К Римлянам", new StringCollection() { "рим", "римл", "римлянам", "к римлянам" } },
                { "14. 1-е Коринфянам", new StringCollection() { "1кор", "1 кор", "1коринф", "1коринфянам", "1-е коринфянам", "1 коринфянам", "1 коринф" } },
                { "15. 2-е Коринфянам", new StringCollection() { "2кор", "2 кор", "2коринф", "2коринфянам", "2-е коринфянам", "2 коринфянам", "2 коринф" } },
                ...
                { "20. 1-е Фессалоникийцам", new StringCollection() { "1фесс", "1фес", "1фессалоникийцам", "1 фес", "1 фесс", "1-е фессалоникийцам", "1 фессалоникийцам" } },
                { "21. 2-е Фессалоникийцам", new StringCollection() { "2фесс", "2фес", "2фессалоникийцам", "2 фес", "2 фесс", "2-е фессалоникийцам", "2 фессалоникийцам" } },
                { "22. 1-е Тимофею", new StringCollection() { "1тим", "1тимоф", "1тимофею", "1 тимофею", "1-е тимофею", "1 тим", "1 тимоф" } },
                { "23. 2-е Тимофею", new StringCollection() { "2тим", "2тимоф", "2тимофею", "2 тимофею", "2-е тимофею", "2 тим", "2 тимоф" } },
